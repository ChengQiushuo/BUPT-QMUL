 ...
 */
public class Order {
    private String order_file = "../jsonfile/order/";
    ...
    public Order(String payment, RamenInfo RamenInfos,ExtraInfo extraInfos) {
        ...
        try {
            ...
            switch (RamenInfo.ramen) {
                case 1:
                    pw.println("Ramen 1: " + RamenInfo.ramenOrder[0] );
                    break;

                case 2:
                    pw.println("Ramen 1: " + RamenInfo.ramenOrder[0] );
                    pw.println("Ramen 2: " + RamenInfo.ramenOrder[1] );
                    break;

                case 3:
                    pw.println("Ramen 1: " + RamenInfo.ramenOrder[0] );
                    pw.println("Ramen 2: " + RamenInfo.ramenOrder[1] );
                    pw.println("Ramen 3: " + RamenInfo.ramenOrder[2] );
                    break;
                ...
                case 4:
                    ...
                    pw.println("Ramen 2: " + RamenInfo.ramenOrder[1] );
                    pw.println("Ramen 3: " + RamenInfo.ramenOrder[2] );
                    pw.println("Ramen 4: " + RamenInfo.ramenOrder[3] );
                    break;
                ...
                case 5:
                    ...
                    pw.println("Ramen 3: " + RamenInfo.ramenOrder[2] );
                    pw.println("Ramen 4: " + RamenInfo.ramenOrder[3] );
                    pw.println("Ramen 5: " + RamenInfo.ramenOrder[4]);
                    break;
            ...
            pw.println("Cost(EUR): " + String.format("%.2f", calculatePrice()));
            pw.println("Dining Way: " +Detail.item);
            pw.close();
            fw.close();
        }
     ...
     */
    public Order(String payment, String number, RamenInfo RamenInfos,ExtraInfo extraInfos,boolean flag) throws IOException {
        RamenInfo = RamenInfos;
        ExtraInfo  = extraInfos;
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss");
        Date d = new Date();
...
//                     mobile=info.getString("mobile_number");
        ...
        try {
            ...
            System.out.println();
            pw.println(number);
            if(flag==true&&RamenInfo.ramen>0&&Integer.parseInt(stamps)>=10&&ExtraInfo.extraCount[0]==0&&ExtraInfo.extraCount[1]==0&&ExtraInfo.extraCount[2]==0&&ExtraInfo.extraCount[3]==0&&ExtraInfo.extraCount[4]==0&&ExtraInfo.extraCount[5]==0&&ExtraInfo.extraCount[6]==0) {
                pw.println("Payment - Stamps");
            }
            else if(flag==true&&RamenInfo.ramen>0&&Integer.parseInt(stamps)>=10) {
            ...
            if(RamenInfo.ramen>0&&Integer.parseInt(stamps)>=10&&flag==true) {
