...
public  void updateReport(ExtraInfo ExtraInfo,RamenInfo RamenInfo) {
    ...
    File f = new File("../jsonfile/report/" + (Integer.parseInt(formatter.format(date)) + 1 - (cal.get(Calendar.DAY_OF_WEEK) - 1)) + "info.json");
    try {
        ...
        for (int i = 0; i < RamenInfo.ramen; i++) {
            String choice1[] = RamenInfo.ramenOrder[i].split("\\,");
            ...
            for (int count = 0; count < Ramen.cominfo.dish_len; count++) {
                ...
                for (int count1 = 0; count1 < array.length(); count1++) {
                    ...
                    String choice2[] = choice1[count].split("\\--");
                    String choice = choice2[1];
                    String s2 = new String(choice);
                    System.out.println("\n");
                    ...
                    if (s2.equals(s1)) {
                        ...
                        OutputStreamWriter osw = new OutputStreamWriter(new FileOutputStream("../jsonfile/report/"
