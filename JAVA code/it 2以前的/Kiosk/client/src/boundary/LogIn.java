...
//    public static String jsonFile = "./file/memberships.json";
    /**
     * The url of the stamp picture displaying on the GUI.
     */
    private String stampPic = "./img/s.png";
    /**
     ...
     */
    public LogIn(RamenInfo RamenInfos,ExtraInfo extraInfos) {
        // Set the frame.
        super("Log in");
        ...
        switch (opt) {
            ...
            case "b2": // Pay
            	if(Integer.parseInt(stamps)<10) {
            		...
            		this.dispose();
                    new Member_pay(temp_num,RamenInfo,ExtraInfo,true);
            	}
...
//                break;
            ...
            case "b4": // Not use
                this.dispose();        
                //需要修改
                new Member_pay(temp_num,RamenInfo,ExtraInfo,false);
                break;
                ...
                int flag = 0;
                   ...
                   int length = memberfile.getMember_length();
                    for (int i = 0; i < length; i++) {
                        ...
                        if(member_number[i].equals(temp_num)) {
                            flag++;
                            stamps = Stamps[i];
                            break;
                        }
